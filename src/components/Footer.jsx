      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 text-center">
          ...
          <div className="flex flex-col items-center">
            ...
            <ul className="space-y-3">
              <li className={`${ITEM} flex items-center justify-center gap-2.5`}>
          ...
          <div className="flex flex-col items-center">
            ...
            <ul className="space-y-3">
              <li>
                <a href="mailto:altamonteenergy@gmail.com" className={`${LINKC} flex items-center justify-center gap-2.5 group`}>
                  <Mail size={16} className="flex-shrink-0 group-hover:scale-110 transition-transform" />
                  altamonteenergy@gmail.com
                </a>
              </li>
              <li>
                <a href="https://wa.me/573045886447" target="_blank" rel="noopener noreferrer" className={`${LINKC} flex items-center justify-center gap-2.5 group`}>
        ...
        <div className="border-t border-[#2ecc71]/10 mt-12 pt-8">
          <div className="flex flex-col items-center justify-center gap-3 text-white/50 text-sm text-center">
