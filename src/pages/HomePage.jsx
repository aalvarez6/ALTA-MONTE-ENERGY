...
import {
  Sun, Zap, Wrench, Users, Plug, Boxes, Cpu, Smartphone,
  TrendingUp, Wallet, Bell, BatteryCharging, Shield, Home, Eye,
  Leaf, Settings, Sprout, BarChart3, Mail, Phone, MapPin, Clock, Globe, Check
} from 'lucide-react'
import './HomePage.css'
...
const IMG = {
  ...
  logo:        '/AM_Imagenes/Logo_White.png',
...
const HomePage = () => {
  ...
  /* Barras animadas del mini-dashboard */
  useEffect(() => {
    ...
    <div className="amhome">
      ...
      <section className="hero" style={{ backgroundImage: `url('${heroBg}')` }}>
        ...
        <div className="hero-cnt">
          ...
          <div className="hero-chips">
            <span className="hchip"><span className="hchip-icon"><Sun size={15} /></span> Solar distribuido</span>
            <span className="hchip"><span className="hchip-icon"><Boxes size={15} /></span> Gemelo digital</span>
            <span className="hchip"><span className="hchip-icon"><Cpu size={15} /></span> IA predictiva</span>
            <span className="hchip"><span className="hchip-icon"><Home size={15} /></span> Impacto comunitario</span>
          </div>
        </div>
      ...
      <section className="section light" id="nodos">
        ...
        <div className="pilares">
          <div className="pilar"><span className="p-icon"><Sun size={26} strokeWidth={1.8} /></span><h4>Generación solar</h4><p>Paneles + batería LFP comunitaria, validada con estudios estructurales previos en cada edificio.</p></div>
          <div className="pilar"><span className="p-icon"><Zap size={26} strokeWidth={1.8} /></span><h4>Optimización 24/7</h4><p>El nodo decide cuándo cargar, usar o compartir. Despacho óptimo con IA que cuida la factura.</p></div>
          <div className="pilar"><span className="p-icon"><Wrench size={26} strokeWidth={1.8} /></span><h4>Mantenimiento predictivo</h4><p>El gemelo digital detecta fallas antes de que ocurran. Alertas automáticas al técnico responsable.</p></div>
          <div className="pilar"><span className="p-icon"><Users size={26} strokeWidth={1.8} /></span><h4>Derechos energéticos</h4><p>Cada familia ve su consumo y su derecho al recurso compartido en tiempo real, sin intermediarios.</p></div>
        </div>
      ...
      <section className="section dark" id="tecnologia">
        ...
        <div className="tech-grid">
          <div className="tc"><span className="tc-i"><Plug size={26} strokeWidth={1.8} /></span><div className="tc-t">Capa IoT</div><div className="tc-d">ESP32 + Modbus RS485 · LoRaWAN sin WiFi · MQTT broker local · Edge computing en nodo.</div></div>
          <div className="tc"><span className="tc-i"><Boxes size={26} strokeWidth={1.8} /></span><div className="tc-t">Gemelo digital</div><div className="tc-d">InfluxDB + Grafana · Modelo en tiempo real de consumo, generación y batería por nodo.</div></div>
          <div className="tc"><span className="tc-i"><Cpu size={26} strokeWidth={1.8} /></span><div className="tc-t">IA predictiva</div><div className="tc-d">Pronóstico de demanda, despacho óptimo y detección temprana de anomalías.</div></div>
          <div className="tc"><span className="tc-i"><Smartphone size={26} strokeWidth={1.8} /></span><div className="tc-t">Dashboard + alertas</div><div className="tc-d">API + frontend web · Alertas de ahorro y estado por WhatsApp para cada hogar.</div></div>
        </div>
        <div style={{ textAlign: 'center', marginTop: 40 }}>
        ...
        <div className="db-inner">
          <div>
            ...
            <div className="db-feats">
              <div className="db-f"><div className="df-i"><TrendingUp size={20} strokeWidth={1.8} /></div><div className="df-t"><h4>Generación vs consumo</h4><p>Curvas en tiempo real por nodo y por hogar, hora a hora.</p></div></div>
              <div className="db-f"><div className="df-i"><Wallet size={20} strokeWidth={1.8} /></div><div className="df-t"><h4>Ahorro de la comunidad</h4><p>Cuánto aporta cada familia y el nodo, de forma transparente y verificable.</p></div></div>
              <div className="db-f"><div className="df-i"><Bell size={20} strokeWidth={1.8} /></div><div className="df-t"><h4>Alertas WhatsApp</h4><p>Batería llena, consumo inusual o falla — mensaje directo a cada familia.</p></div></div>
            </div>
      ...
      <section className="section darkest" id="impacto">
        ...
        <div className="imp-g">
          <div className="imp-c"><div className="imp-ic"><BatteryCharging size={28} strokeWidth={1.8} /></div><div className="imp-t">Menor dependencia</div><div className="imp-l">La energía solar compartida alivia la carga de la red convencional para toda la comunidad.</div></div>
          <div className="imp-c"><div className="imp-ic"><Shield size={28} strokeWidth={1.8} /></div><div className="imp-t">Resiliencia</div><div className="imp-l">Respaldo comunitario ante cortes e interrupciones del servicio eléctrico.</div></div>
          <div className="imp-c"><div className="imp-ic"><Home size={28} strokeWidth={1.8} /></div><div className="imp-t">Hecho para la ladera</div><div className="imp-l">Diseñado específicamente para los barrios de ladera de Medellín y su realidad.</div></div>
          <div className="imp-c"><div className="imp-ic"><Eye size={28} strokeWidth={1.8} /></div><div className="imp-t">Transparencia</div><div className="imp-l">Cada kilovatio visible y compartido con toda la comunidad en tiempo real.</div></div>
        </div>
        <div className="roadmap">
          <div className="rm"><div className="rm-d done"><Check size={20} strokeWidth={2.5} /></div><div className="rm-t">MVP Digital</div><div className="rm-i">Landing · API · Dashboard</div></div>
          <div className="rm"><div className="rm-d now"><Zap size={20} strokeWidth={2} /></div><div className="rm-t">Nodo Piloto</div><div className="rm-i">La Torre · IoT real</div></div>
          <div className="rm"><div className="rm-d nxt"><Cpu size={20} strokeWidth={2} /></div><div className="rm-t">IA Real</div><div className="rm-i">Pronóstico · Despacho óptimo</div></div>
          <div className="rm"><div className="rm-d nxt"><Globe size={20} strokeWidth={2} /></div><div className="rm-t">Escala</div><div className="rm-i">Más comunidades · LATAM</div></div>
        </div>
      ...
      <section className="carta-out">
        <div className="carta-inner">
          ...
          <div className="carta">
            <div className="cl">
              <div className="cl-hd"><span><Leaf size={17} strokeWidth={1.8} /></span> Nuestro propósito</div>
              ...
              <div className="cl-hd"><span><Settings size={17} strokeWidth={1.8} /></span> Lo que hacemos</div>
              ...
              <div className="cl-hd"><span><Sprout size={17} strokeWidth={1.8} /></span> Nuestro impacto</div>
              <ul className="cl-ul">
            ...
            <div className="cm" style={{ backgroundImage: `url('${heroBg}')` }}>
              ...
              <div className="cm-cnt">
                ...
                <div className="nb"><div className="nb-i"><Sun size={18} strokeWidth={1.8} /></div><div className="nb-t"><strong>Generación solar</strong>Paneles + batería comunitaria compartida</div></div>
                <div className="nb"><div className="nb-i"><Cpu size={18} strokeWidth={1.8} /></div><div className="nb-t"><strong>Inteligencia artificial</strong>Optimización y predicción 24/7</div></div>
                <div className="nb"><div className="nb-i"><BarChart3 size={18} strokeWidth={1.8} /></div><div className="nb-t"><strong>Gemelo digital</strong>Monitoreo en tiempo real</div></div>
                <div className="nb"><div className="nb-i"><Users size={18} strokeWidth={1.8} /></div><div className="nb-t"><strong>Impacto comunitario</strong>Derechos energéticos distribuidos</div></div>
              </div>
            </div>
            <div className="cr">
        ...
        <div className="contacto-wrap">
          <div className="form-info">
            ...
            <div className="fci-list">
              <div className="fci"><div className="fci-icon"><Mail size={17} strokeWidth={1.8} /></div><div><div className="fci-label">Email</div><a href="mailto:altamonteenergy@gmail.com" className="fci-val">altamonteenergy@gmail.com</a></div></div>
              <div className="fci"><div className="fci-icon"><Phone size={17} strokeWidth={1.8} /></div><div><div className="fci-label">WhatsApp</div><a href="https://wa.me/573045886447" target="_blank" rel="noopener noreferrer" className="fci-val">+57 304 588 6447</a></div></div>
              <div className="fci"><div className="fci-icon"><MapPin size={17} strokeWidth={1.8} /></div><div><div className="fci-label">Ubicación</div><span className="fci-val">Medellín, Colombia</span></div></div>
              <div className="fci"><div className="fci-icon"><Clock size={17} strokeWidth={1.8} /></div><div><div className="fci-label">Tiempo de respuesta</div><span className="fci-val">Menos de 24 horas</span></div></div>
            </div>
          </div>
          <div>
