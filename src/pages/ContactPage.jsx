...
const ContactPage = () => {
  ...
  return (
    <div className="pt-16 min-h-screen bg-white dark:bg-[#0b3d2e]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-16">
          <h1 className="text-5xl font-bold text-[#0b3d2e] dark:text-white mb-4">Contacto</h1>
          <p className="text-xl text-[#5a7a6a] dark:text-white/60 max-w-3xl">
            Cuéntanos sobre tu comunidad, tu barrio o tu idea. Respondemos en menos de 24 horas.
          </p>
        </div>

        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="bg-gradient-to-br from-[#F7F4EF] to-white dark:from-[#123b2c] dark:to-[#0d2c21] rounded-2xl p-8 border border-[#2ecc71]/20 dark:border-[#2ecc71]/25">
            <div className="w-12 h-12 bg-[#2ecc71]/20 rounded-lg flex items-center justify-center mb-4">
              <Mail className="w-6 h-6 text-[#0b3d2e] dark:text-[#2ecc71]" />
            </div>
            <h3 className="text-lg font-bold text-[#0b3d2e] dark:text-white mb-2">Email</h3>
          ...
          <div className="bg-gradient-to-br from-[#F7F4EF] to-white dark:from-[#123b2c] dark:to-[#0d2c21] rounded-2xl p-8 border border-[#2ecc71]/20 dark:border-[#2ecc71]/25">
            <div className="w-12 h-12 bg-[#2ecc71]/20 rounded-lg flex items-center justify-center mb-4">
              <Phone className="w-6 h-6 text-[#0b3d2e] dark:text-[#2ecc71]" />
            </div>
            <h3 className="text-lg font-bold text-[#0b3d2e] dark:text-white mb-2">WhatsApp</h3>
          ...
          <div className="bg-gradient-to-br from-[#F7F4EF] to-white dark:from-[#123b2c] dark:to-[#0d2c21] rounded-2xl p-8 border border-[#2ecc71]/20 dark:border-[#2ecc71]/25">
            <div className="w-12 h-12 bg-[#2ecc71]/20 rounded-lg flex items-center justify-center mb-4">
              <MapPin className="w-6 h-6 text-[#0b3d2e] dark:text-[#2ecc71]" />
            </div>
            <h3 className="text-lg font-bold text-[#0b3d2e] dark:text-white mb-2">Ubicación</h3>
            <p className="text-[#5a7a6a] dark:text-white/60 font-semibold">
              Medellín, Colombia
            </p>
          </div>
        </div>
        ...
        <div className="max-w-2xl mx-auto mb-16">
          <form onSubmit={handleSubmit} className="bg-gradient-to-br from-[#F7F4EF] to-white dark:from-[#123b2c] dark:to-[#0d2c21] rounded-2xl p-12 border border-[#2ecc71]/20 dark:border-[#2ecc71]/25">
            <div className="mb-6">
              <label className="block text-sm font-bold text-[#0b3d2e] dark:text-white mb-2">
                Nombre completo *
              </label>
              <input
                type="text"
                ...
                className="w-full px-4 py-3 border border-[#2ecc71]/30 rounded-lg focus:outline-none focus:border-[#2ecc71] bg-white dark:bg-[#0b3d2e] dark:text-white dark:placeholder-white/40"
                required
              />
            </div>
            ...
            <div className="mb-6">
              ...
              <select
                ...
                onChange={handleChange}
                className="w-full px-4 py-3 border border-[#2ecc71]/30 rounded-lg focus:outline-none focus:border-[#2ecc71] bg-white dark:bg-[#0b3d2e] dark:text-white"
              >
            ...
            <div className="mb-8">
              ...
              <textarea
                ...
                rows="6"
                className="w-full px-4 py-3 border border-[#2ecc71]/30 rounded-lg focus:outline-none focus:border-[#2ecc71] bg-white dark:bg-[#0b3d2e] dark:text-white dark:placeholder-white/40 resize-none"
                required
              ></textarea>
            </div>
            ...
            {estado === 'ok' && (
              <div className="mt-6 p-4 bg-[#f0fdf4] dark:bg-[#0f2e22] border border-[#2ecc71] text-[#0b3d2e] dark:text-white rounded-lg text-center font-semibold">
                ✓ ¡Mensaje enviado! Te contactaremos en menos de 24 horas.
              </div>
            )}

            {estado === 'error' && (
              <div className="mt-6 p-4 bg-[#fef2f2] dark:bg-[#3a1414] border border-[#ef4444] text-[#991b1b] dark:text-[#fca5a5] rounded-lg text-center font-semibold">
        ...
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl font-bold text-[#0b3d2e] dark:text-white mb-8 text-center">Preguntas Frecuentes</h2>
          <div className="space-y-4">
            <details className="bg-[#F7F4EF] dark:bg-[#123b2c] rounded-lg p-6 cursor-pointer group hover:bg-[#f0ebe1] dark:hover:bg-[#16473a] transition-colors">
              <summary className="font-bold text-[#0b3d2e] dark:text-white text-lg flex items-center justify-between">
                ¿Cuánto cuesta instalar un nodo en mi barrio?
                <span className="group-open:rotate-180 transition-transform">▼</span>
              </summary>
              <p className="text-[#5a7a6a] dark:text-white/60 mt-4 leading-relaxed">
